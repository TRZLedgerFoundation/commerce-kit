...
export function getMerchantOperatorConfigEncoder(): FixedSizeEncoder<MerchantOperatorConfigArgs> {
  return getStructEncoder([
    ...
    ['currentOrderId', getU32Encoder()],
    ['daysToClose', getU16Encoder()],
    ['numPolicies', getU32Encoder()],
    ['numAcceptedCurrencies', getU32Encoder()],
  ]);
}
...
export function getMerchantOperatorConfigDecoder(): FixedSizeDecoder<MerchantOperatorConfig> {
  return getStructDecoder([
    ...
    ['currentOrderId', getU32Decoder()],
    ['daysToClose', getU16Decoder()],
    ['numPolicies', getU32Decoder()],
    ['numAcceptedCurrencies', getU32Decoder()],
  ]);
}

export function getMerchantOperatorConfigCodec(): FixedSizeCodec<
