...
export const CLOSE_PAYMENT_DISCRIMINATOR = 9;

export function getClosePaymentDiscriminatorBytes() {
  return getU8Encoder().encode(CLOSE_PAYMENT_DISCRIMINATOR);
}
...
export function getClosePaymentInstructionDataEncoder(): FixedSizeEncoder<ClosePaymentInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: CLOSE_PAYMENT_DISCRIMINATOR })
  );
}
...
export function getClosePaymentInstructionDataCodec(): FixedSizeCodec<
  ClosePaymentInstructionDataArgs,
  ClosePaymentInstructionData
> {
  return combineCodec(
    getClosePaymentInstructionDataEncoder(),
    getClosePaymentInstructionDataDecoder()
  );
}

export type ClosePaymentAsyncInput<
...
export async function getClosePaymentInstructionAsync<
  TAccountPayer extends string,
  TAccountPayment extends string,
  TAccountOperatorAuthority extends string,
  TAccountOperator extends string,
...
export function getClosePaymentInstruction<
  TAccountPayer extends string,
  TAccountPayment extends string,
  TAccountOperatorAuthority extends string,
  TAccountOperator extends string,
