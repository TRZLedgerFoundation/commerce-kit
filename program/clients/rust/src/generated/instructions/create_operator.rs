...
pub const CREATE_OPERATOR_DISCRIMINATOR: u8 = 1;
...
impl CreateOperator {
  pub fn instruction(&self, args: CreateOperatorInstructionArgs) -> trezoa_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateOperatorInstructionArgs, remaining_accounts: &[trezoa_instruction::AccountMeta]) -> trezoa_instruction::Instruction {
