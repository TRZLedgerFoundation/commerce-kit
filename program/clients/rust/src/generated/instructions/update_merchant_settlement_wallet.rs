...
pub struct UpdateMerchantSettlementWallet {
          ...
          pub new_settlement_wallet: trezoa_pubkey::Pubkey,
      }
...
pub struct UpdateMerchantSettlementWalletBuilder {
            payer: Option<trezoa_pubkey::Pubkey>,
                ...
                new_settlement_wallet: Option<trezoa_pubkey::Pubkey>,
...
#[inline(always)]
    pub fn merchant(&mut self, merchant: trezoa_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn new_settlement_wallet(&mut self, new_settlement_wallet: trezoa_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> trezoa_instruction::Instruction {
    let accounts = UpdateMerchantSettlementWallet {
                              payer: self.payer.expect("payer is not set"),
                                        ...
                                        new_settlement_wallet: self.new_settlement_wallet.expect("new_settlement_wallet is not set"),
                      };
  ...
  pub struct UpdateMerchantSettlementWalletCpiAccounts<'a, 'b> {
              ...
              pub new_settlement_wallet: &'b trezoa_account_info::AccountInfo<'a>,
            }
...
#[inline(always)]
    pub fn merchant(&mut self, merchant: &'b trezoa_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn new_settlement_wallet(&mut self, new_settlement_wallet: &'b trezoa_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> trezoa_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          new_settlement_wallet: self.instruction.new_settlement_wallet.expect("new_settlement_wallet is not set"),
                    };
...
struct UpdateMerchantSettlementWalletCpiBuilderInstruction<'a, 'b> {
  __program: &'b trezoa_account_info::AccountInfo<'a>,
            payer: Option<&'b trezoa_account_info::AccountInfo<'a>>,
                ...
                new_settlement_wallet: Option<&'b trezoa_account_info::AccountInfo<'a>>,
