...
export const TOKENS: Record<PaymentMethod, TokenConfig> = {
    TRZ: {
        ...
        decimals: 9,
        name: 'Trezoa',
        icon: 'https://raw.githubusercontent.com/trezoa-team/token-list/main/assets/mainnet/So11111111111111111111111111111111111111112/logo.png',
    },
    USDC: {
        ...
        decimals: 6,
        name: 'USD Coin',
        icon: 'https://raw.githubusercontent.com/trezoa-team/token-list/main/assets/mainnet/EFewYfHeQhkKpbDzpmyygdT54hn85dUj3VZ8b7dC21KS/logo.png',
    },
    USDT: {
        ...
        decimals: 6,
        name: 'Tether USD',
        icon: 'https://raw.githubusercontent.com/trezoa-team/token-list/main/assets/mainnet/GHPjs7ftoZVdvKYvnxCiRD3i5t3dNSkLyQaoBQLRb5PA/logo.png',
    },
};
