...
// Utility functions
export const getBorderRadius = (radius?: BorderRadius): string => BORDER_RADIUS_MAP[radius ?? 'lg'];

export const getModalBorderRadius = (radius?: BorderRadius): string => getRadius('modal', radius);

export const getContainerBorderRadius = (radius?: BorderRadius): string => CONTAINER_BORDER_RADIUS_MAP[radius ?? 'md'];
...
// Custom hooks
export const useTheme = (theme?: ThemeConfig) => useMemo(() => ({ ...DEFAULT_THEME, ...theme }), [theme]);
