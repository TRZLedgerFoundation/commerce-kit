...
export function TransactionSuccess({
    ...
    return (
        <div
            className="ck-transaction-success ck-transaction-success-container"
                    ...
                    <div className="ck-transaction-success-message" style={{ color: theme.textColor }}>
                        ...
                        <div className="ck-transaction-token-info">
                            {amount !== undefined
                                ...
                                : `${displayAmount} in ${selectedCurrency}`}
                        </div>
                        {recipient && <div>to {formatAddress(recipient)}</div>}
                        {signature && <div>Transaction: {formatAddress(signature)}</div>}
                    </div>
                </div>
