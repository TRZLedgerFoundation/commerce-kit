...
interface TrezoaPayIconProps {
    size?: number;
    className?: string;
    'data-testid'?: string;
}

export const TrezoaPayIcon: React.FC<TrezoaPayIconProps> = ({ size = 16, className, 'data-testid': testId }) => {
    return (
        <svg
            width={size}
            ...
            className={className}
            role="img"
            aria-label="Trezoa Pay"
            data-testid={testId || 'trezoa-pay-icon'}
            data-size={size}
        >
            <path
