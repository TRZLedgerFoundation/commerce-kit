...
interface TrezoaIconProps {
    size?: number;
    className?: string;
    'data-testid'?: string;
}

export const TrezoaIcon: React.FC<TrezoaIconProps> = ({ size = 24, className, 'data-testid': testId }) => {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            ...
            <path
                ...
                stroke="url(#paint0_linear_trezoa)"
                strokeOpacity="0.39"
            />
            <mask
                id="mask0_trezoa"
            ...
            <g mask="url(#mask0_trezoa)">
                <g filter="url(#filter0_f_trezoa)">
                    <path
            ...
            <defs>
                ...
                >
                    ...
                    <feGaussianBlur stdDeviation="22" result="effect1_foregroundBlur_trezoa" />
                </filter>
                <linearGradient
                    id="paint0_linear_trezoa"
                    x1="23.1811"
                    y1="7.03724"
                    x2="71.5766"
                    y2="90.001"
