            ...
            pollingIntervalRef.current = setInterval(async () => {
                ...
                try {
                    ...
                    const signatures = await client.rpc
                        .getSignaturesForAddress(addressToCheck, {
                            limit: 10,
                ...
                <div className="ck-qr-viewfinder">
                    ...
                    >
                        <path
                            ...
                            fill={paymentStatus.status === 'error' ? '#FF0000' : '#2D2D2D'}
                            fillOpacity={paymentStatus.status === 'error' ? '0.56' : '0.24'}
                        />
                    </svg>
                            ...
                            if (!paymentRequest) {
                                return (
                                    <div className="ck-qr-state-container">
                                        ...
                                        <button onClick={() => window.location.reload()} className="ck-qr-retry-button">
                                            Retry
                                        </button>
                                    </div>
                                );
                            ...
                            if (paymentStatus.status === 'error' || paymentStatus.status === 'timeout') {
                                return (
                                    <div className="ck-qr-error-container">
                                        ...
                                        <div className="ck-qr-error-title">Payment time out</div>
                                        <button
                                            onClick={() => {
                                                paymentStatus.reset();
                                                paymentTimer.reset();
                                ...
                                <div className="ck-qr-code-container">
                                    ...
                                    {paymentStatus.status === 'processing' && (
                                        ...
                                        >
                                            ...
                                            />
                                            <div className="ck-qr-processing-title" style={{ color: theme.textColor }}>
                                                Payment Detected!
                                            </div>
                                            <div
                ...
                {paymentStatus.status !== 'success' && (
                    <div className="ck-timer-container">
                        <div className="ck-timer-pill">
                            ...
                            <span>{paymentTimer.formatTime()}</span>
                        </div>
                    </div>
                )}
