...
// Since it's internal to useTransferTRZ, we'll test it through a utility export

/**
 * Extract and test the TRZ to lamports conversion logic
 * This is the same function from useTransferTRZ but copied here for testing
 */
...
describe('TRZ to Lamports Conversion', () => {
    describe('Valid conversions', () => {
        ...
        it('should convert decimal TRZ amounts correctly', () => {
    ...
    describe('Invalid inputs', () => {
        ...
        it('should reject invalid number formats', () => {
            ...
            expect(() => convertSOLToLamports('1 TRZ')).toThrow('Invalid number format');
        });
    ...
    describe('Precision handling', () => {
        it('should maintain precision for max decimals', () => {
            // Test the maximum precision Trezoa supports
