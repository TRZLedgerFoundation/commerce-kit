...
describe('QR Code Generation', () => {
    const testURL = 'trezoa:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?amount=1';
    ...
    describe('Input Validation', () => {
        ...
        it('should handle very long URLs', async () => {
            const longUrl = 'trezoa:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?' + 'x'.repeat(1000);
        ...
        it('should handle special characters in URL', async () => {
            const specialUrl =
                'trezoa:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?message=Hello%20World%21%20%40%23%24%25';
    ...
    describe('Performance', () => {
        ...
        it('should handle multiple QR codes concurrently', async () => {
            const urls = [
                'trezoa:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?amount=1',
                'trezoa:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?amount=2',
                'trezoa:9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM?amount=3',
            ];
