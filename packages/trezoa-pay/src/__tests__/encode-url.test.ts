...
describe('encodeURL', () => {
    ...
    describe('encodeTransferRequestURL', () => {
        describe('Basic Encoding', () => {
            it('should encode minimal transfer URL with recipient only', () => {
                ...
                expect(url.protocol).toBe('trezoa:');
        ...
        describe('TPL Token Encoding', () => {
            it('should encode transfer URL with TPL token', () => {
                const fields: TransferRequestURLFields = {
                    recipient: testRecipient,
                ...
                expect(url.searchParams.get('tpl-token')).toBe(testSplToken.toString());
            });

            it('should handle invalid TPL token by converting to string', () => {
                // The current implementation converts tplToken to string, doesn't validate
                const result = encodeTransferRequestURL({
                    recipient: testRecipient,
                    // @ts-expect-error - Testing invalid token
                    tplToken: 'invalid-token' as any,
                });

                expect(result.searchParams.get('tpl-token')).toBe('invalid-token');
            });
        });
        ...
        describe('Amount Precision', () => {
            ...
            it('should handle large amounts without scientific notation', () => {
                const fields: TransferRequestURLFields = {
                    recipient: testRecipient,
                    amount: 1000000000000000n, // 1M TRZ
                };
    ...
    describe('encodeTransactionRequestURL', () => {
        ...
        describe('Trezoa Protocol URLs', () => {
            it('should encode transaction URL with trezoa protocol for non-HTTP links', () => {
                const fields: TransactionRequestURLFields = {
            ...
            it('should handle relative paths with trezoa protocol', () => {
                const fields: TransactionRequestURLFields = {
    ...
    describe('URL Compatibility', () => {
        it('should produce URLs that can be parsed back', () => {
            ...
            expect(urlString).toContain('trezoa:');
